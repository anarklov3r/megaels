...
#define HC_SCALE_1           1        // 1st position, scale = 1 hundred/tick = 1mm/revolution
#define HC_SCALE_10          10       // 2nd position, scale = 10 hundredths/tick = 10mm/revolution
...
#define Encoder_Init()         DDRD = B00000000;\
                               PORTD = B11111111        // lift PIN_21, 20, 19, 18
...
// ***** Hand_Coder *****            // Z/X: Input-E4,E5, lift-E4,E5, X1/X10: Input-J0,J1, lift-J0,J1.
...
#define Limit_Init()           DDRA = B10101010;\
                               PORTA = B01010101    // IN-A0,A2,A4,A6, OUT-A1,A3,A5,A7, lift
...
#define Joy_Init()             DDRK = B00000000;\
                               PORTK = B11111111;    // lift PIN_A8, A9, A10, A11, A12 // Submode Sw: A13, A14, A15
...
#define Mode_Switch_Init()     DDRC = B00000000;\
                               PORTC = B11111111;        // lift PORT_A, MANDATORY! external lift to +5 via 1K resistors
...
//static_assert(Thrd_Accel_Err + THRD_ACCEL <= 255, "The THRD_ACCEL value is set incorrectly");
